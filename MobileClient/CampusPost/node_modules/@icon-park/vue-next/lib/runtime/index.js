...
exports.IconProvider = exports.DEFAULT_ICON_CONFIGS = void 0;
...
var IconProvider = function IconProvider(config) {
  (0, _runtimeDom.provide)(IconContext, config);
};
...
function IconWrapper(name, rtl, render) {
  var options = {
    ...
    setup: function setup(props) {
      var id = guid();
      var ICON_CONFIGS = (0, _runtimeDom.inject)(IconContext, DEFAULT_ICON_CONFIGS);
      return function () {
        var size = props.size,
